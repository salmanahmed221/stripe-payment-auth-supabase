      ...
      <div className="flex flex-wrap justify-center lg:space-x-4 space-y-4 lg:space-y-0 items-stretch">
        {pricingOptions.map((option, index) => (
          ...
          >
            ...
            <button
                onClick={() => option.buttonText === "Choose Starter" ? handleCheckout("1 Credit",12)   : option.buttonText === "Choose Basic" ? handleCheckout("3 Credit", 30) : handleCheckout("5 Credit", 40) }
